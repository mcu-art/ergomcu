...
extern "C"
{
	 ...
	 * (as they are in STM32 MCU family), and there is only one reader and one writer.
	 * Under these conditions, it is lock-free and no further synchronization is needed.
	 */
	typedef struct ringbuf32_s
	{
		...
		volatile uint32_t peakUnread; /* stores peak unread data size for statistics and debug purposes */
